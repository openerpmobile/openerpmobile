...
public class DBManagement
{
	...
	public void addCustomer (Customer customer)
	{
	    ...
	    //i wprowadzamy to niej dane, podaj¹c jako klucz nazwê kolumny a drugi argument to wartoœæ
	...
	private Customer cursorToCustomer (Cursor cursor)
	{
	    ...
	    //wartoœæ z danej kolumny w wierszu wskazywanym przez kursor pozyskujemy metod¹ get<typ>(int index_kolumny)
	    //przy czym numeracja kolumn jest od 0
		Customer customer = new Customer(cursor.getLong(0), cursor.getString(1), cursor.getString(2),
	...
	public ArrayList<Customer> fetchData ()
	{
	    ...
	    //ustawiamy kursor na pozycjê -1, czyli przed pierwszym wierszem (numeracja od 0)
		Cursor cursor = db.query(dbHelper.getTableName(), dbHelper.getAllCols(), 
						null, null, null, null, null);
		
	    //dopóki nie wyjdziemy poza tablicê
		while (cursor.moveToNext())
	        //zamieñ wiersz wskazywany przez cursor na Customer i dodaj go do listy
	...
	public void removeCustomer (String name)
	{
		...
		while (cursor.moveToNext() && 0!=cursorToCustomer(cursor).getName().compareTo(name))
		{ ; }
		...
		if (!cursor.isAfterLast())
		{
			...
			db.delete(dbHelper.getTableName(), BaseColumns._ID + " = " + idToRemove, null);
		}
	}
	...
	public long rowsCount ()
	{
		...
		Cursor cursor = db.query(dbHelper.getTableName(), dbHelper.getColsWithoutID(), 
				null, null, null, null, null);           //          ^mówi³em, ¿e siê przyda:D
	    //to bêdze zwracany licznik
		long i;
		
	    //dopóki jest nastêpny wiersz to ustaw nie niego kursor i zinkrementuj licznik (takie ma³e a cieszy:)
